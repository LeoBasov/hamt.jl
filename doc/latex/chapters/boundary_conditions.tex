...
\section{Heat Flux - radiation branch}
...
\end{equation}
Assuming a normal vector we get
\begin{equation}
	\vec{n} \cdot \nabla T = \frac{1}{\det\left(\mm{J}(x,y)\right)}
	\vec{n} \cdot
	\begin{pmatrix}
...
\begin{align}
	...
	\begin{pmatrix}
		T_0(\Delta y_1 - \Delta y_2) + T_1\Delta y_2 - T_2\Delta y_1\\
		T_0(\Delta x_2 - \Delta x_1) - T_1 \Delta x_2 + T_2 \Delta x_1
	\end{pmatrix} &\iint \phi_0 \diff{\xi} \diff{\eta} =\\
...
\begin{equation}
	\boxed{
		...
		\begin{pmatrix}
			...
			T_0(\Delta x_2 - \Delta x_1) - T_1 \Delta x_2 + T_2 \Delta x_1
		\end{pmatrix}
		= -\frac{\dot{q}_{\perp} \det\left( \mm{J}(x, y) \right)}{\lambda}}
\end{equation}
